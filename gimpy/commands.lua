...
commands.screenshot = "maim -u ~/screenshots/$(date +'%Y-%m-%d_%H:%M:%S').png"
commands.screenshot_draw  = "sleep 1; maim -u -s ~/screenshots/$(date +'%Y-%m-%d_%H:%M:%S').png"
commands.screenshot_active_window  = "maim -i $(xdotool getactivewindow) -u ~/screenshots/$(date +'%Y-%m-%d_%H:%M:%S').png"
